  ...
  return (
    <section id="skills" className="py-14 border-t border-hairline">
      <div className="max-w-3xl mx-auto px-7">
        <Reveal>
          <div className="font-mono text-xs text-signal tracking-wide mb-2">// 02 — STACK</div>
          <h2 className="font-serif text-[26px] font-medium mb-9">Skills</h2>
        </Reveal>

        {skills.map((group, i) => (
          <Reveal key={group.group} delay={i * 0.06} className="mb-6 last:mb-0">
            <h3 className="font-mono text-xs text-slate tracking-wide mb-3">{group.group.toUpperCase()}</h3>
